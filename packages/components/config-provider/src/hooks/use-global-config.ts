...
import { debugWarn, keysOf } from '@limo-ui/utils'
import {
  SIZE_INJECTION_KEY,
  defaultNamespace,
...
// this is meant to fix global methods like `LmMessage(opts)`, this way we can inject current locale
...
// for components like `LmMessage` `LmNotification` `LmMessageBox`.
