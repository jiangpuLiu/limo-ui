...
import { buildProps } from '@limo-ui/utils'
...
import '@limo-ui/theme/src/$INPUT_NAME.scss'
EOF

cat > $DIRNAME/style/css.ts <<EOF
import '@limo-ui/components/base/style/css'
import '@limo-ui/theme/el-$INPUT_NAME.css'
EOF
